...
function SplitWithImage() {
  return (
    <Container px={"20"} maxW={"full"} py={12} bg={useColorModeValue("pink.50", "pink.800")} mt={0} centerContent overflow="hidden">
...
export default function Hero() {
  ...
  return (
    <Container maxW={"full"} w={"100%"} mr={"0"} px={"0"}>
      <Stack px={"20"} align={"center"} spacing={{ base: 8, md: 10 }} py={{ base: 20, md: 28 }} direction={{ base: "column", md: "row" }}>
        <Stack flex={1} spacing={{ base: 5, md: 10 }}>
          ...
          <Stack spacing={{ base: 4, sm: 6 }} direction={{ base: "column", sm: "row" }}>
            <Button rounded={"md"} onClick={buttonHandler} size={"lg"} fontWeight={"normal"} px={6} colorScheme={"pink"} bg={"pink.400"} _hover={{ bg: "pink.500" }}>
              Mulai
            </Button>
          </Stack>
        </Stack>
