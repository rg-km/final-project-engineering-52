import {
  ...
  import { FaInstagram, FaTwitter, FaFacebook, FaTelegramPlane } from 'react-icons/fa';
  ...
  export default function LargeWithNewsletter() {
    return (
      <Box
        bg={useColorModeValue('#434343')}
        color={useColorModeValue('white')}>
        <Container as={Stack} maxW={'full'} py={10} px={100} >
          <SimpleGrid
            templateColumns={{ sm: '1fr 1fr', md: '2fr 1fr 1fr 2fr' }}
            spacing={8}>
            <Stack spacing={6} align={'left'}>
            <Text fontSize={'25'} align={'left'}>
                GO-SCHOLARSHIP
            </Text>
            <Input
                placeholder="Sign Up for our Newslater"
                bg={'gray.100'}
                border={0}
                color={'gray.500'}
                _placeholder={{
              ...
              <Text fontSize={'sm'} align={'left'}>
                Copyright @go-scholarship
            </Text> 
            </Stack>
            <Stack align={'flex-start'}>
              <ListHeader>Sitemap</ListHeader>
              <Link href={'#'}>Home</Link>
              <Link href={'./Pages/Listbea'}>Berita Pendidikan</Link>
